...
public class AuthController {
    ...
    public ResponseEntity<JwtDto> login(@RequestBody LoginUsuario loginUsuario){
        ...
        JwtDto jwtDto = new JwtDto(jwt,  usuario.getUsername(),usuario.getNombreCompleto(), usuario.getNombreRol(), usuario.getIdUsuario(), 0, usuario.getAuthorities(), usuario.getOpciones());
