...
public class UsuarioPrincipal implements UserDetails {
	...
	public static UsuarioPrincipal build(Usuario usuario, List<Rol> roles, List<Opcion> opciones) {
		...
		for (Rol x : roles) {
			...
			rolNombre =x.getNombre();
			nombreCompleto = usuario.getNombreCompleto();
		}
		
		return new UsuarioPrincipal(usuario.getIdUsuario(), usuario.getLogin(), usuario.getPassword(), usuario.getNombreCompleto(),rolNombre, authorities, opciones);	}
